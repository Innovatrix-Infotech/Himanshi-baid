...
const FALLBACK_PUBLICATIONS: HBPublication[] = [
  {
    ...
    status: 'published',
    sort: 1,
    title: 'Patients with acute abdomen presenting in the emergency department: A prospective cohort study from a tertiary care centre',
    authors: '',
    journal: 'J Clin Diagn Res',
    year: 2026,
    doi_url: 'https://doi.org/10.7860/JCDR/2026/85746.23541',
    url: '',
    pubmed_id: '',
  ...
  },
  {
    ...
    status: 'published',
    sort: 2,
    title: 'Recreational dance unmasked diaphragmatic hernia misdiagnosed as hydropneumothorax: a case report',
    authors: 'Gupta S, Baid H, Singh M, Kumar M',
    journal: 'South Asian J Case Rep Rev',
    year: 2026,
    doi_url: 'https://doi.org/10.18231/j.sajcrr.16484.1776164188',
    url: '',
    pubmed_id: '',
  ...
  },
  {
    ...
    status: 'published',
    sort: 3,
    title: 'A protocol for evaluation and management in patients with acute undifferentiated fever in the emergency department: a prospective observational study',
    authors: 'Thakur K, Singh M, Baid H, Singh NA, Kaushik S, Shishodiya M',
    journal: 'Int J Med Public Health',
    year: 2026,
    doi_url: '',
    url: '',
    pubmed_id: '',
  ...
  },
  {
    ...
    status: 'published',
    sort: 4,
    title: 'Breaking the Clot: Flexible Bronchoscopic Hydrodissection as a Game Changer in Endobronchial Obstruction: A Case Report',
    authors: 'Kumar M, Sharma K, Bora R, Baid H, Gupta RK, Khanduri R, Gupta D, Thakur K',
    journal: 'Annals of Interventional Pulmonology',
    year: 2026,
    doi_url: '',
    url: '',
    pubmed_id: '',
